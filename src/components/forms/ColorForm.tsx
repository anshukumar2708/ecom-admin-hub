...
import { IColor, IColorFormData } from "@/types/color.type";
import { addColors, updateColor } from "@/services/colorService";
...
export function ColorForm({ open, closeForm, fetchColor, updateData }: IColorFormProps) {
    const [formData, setFormData] = useState<IColorFormData>({
        name: "",
        image: "",
        slug: "",
        description: "",
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            formDataObj.append("folder", "images/colors");
            ...
            const response = updateData?._id
                ? await updateColor(updateData._id, payLoad)
                : await addColors(payLoad);
